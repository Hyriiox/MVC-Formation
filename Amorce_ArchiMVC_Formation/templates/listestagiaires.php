    ...
    <table class="montableau">
        ...
        <?php
            foreach($stagiaires as $stagiaire){
                ...
                echo "<td> <a href='index.php?action=update&id=$stagiaire[id_membre]'> $stagiaire[login_membre] </a></td>";
        ...
        <tr>
            <?php
            echo '<td class="ajouter" colspan="4"><a href="index.php?action=ajout"> Ajouter un stagiaire </a></td>';
            ?>
        </tr>
    </table>
<?php
